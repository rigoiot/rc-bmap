...
var OverviewMap = function (_BaseControl) {
  ...
  function OverviewMap() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = OverviewMap.__proto__ || (0, _getPrototypeOf2.default)(OverviewMap)).call.apply(_ref, [this].concat(args))), _this), _this.getRealControl = function () {
      return new _core.OverviewMap(_this.config, _this.mapInstance);
