...
var TextIcon = (_temp2 = _class = function (_BaseOverlay) {
  ...
  function TextIcon() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = TextIcon.__proto__ || (0, _getPrototypeOf2.default)(TextIcon)).call.apply(_ref, [this].concat(args))), _this), _this.getRealOverlay = function () {
      return new _core.TextIcon(_this.config, _this.mapInstance);
  ...
  return TextIcon;
}(_BaseOverlay3.default), _class.contextTypes = {
