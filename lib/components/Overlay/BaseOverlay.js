...
var BaseOverlay = (_temp2 = _class = function (_PureComponent) {
  (0, _inherits3.default)(BaseOverlay, _PureComponent);
  ...
  function BaseOverlay() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = BaseOverlay.__proto__ || (0, _getPrototypeOf2.default)(BaseOverlay)).call.apply(_ref, [this].concat(args))), _this), _this.overlay = null, _this.mapInstance = null, _this.config = {}, _this.centralizedUpdates = function (_ref2) {
      var name = _ref2.name,
          data = _ref2.data;
  ...
  (0, _createClass3.default)(BaseOverlay, [{
    key: 'getChildContext',
