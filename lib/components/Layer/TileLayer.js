...
var TileLayer = (_temp = _class = function (_PureComponent) {
  (0, _inherits3.default)(TileLayer, _PureComponent);
  ...
  (0, _createClass3.default)(TileLayer, [{
    ...
    value: function componentDidMount() {
      ...
      var layer = new _core.TileLayer(this.config, this.mapInstance);
      this.layer = layer;
