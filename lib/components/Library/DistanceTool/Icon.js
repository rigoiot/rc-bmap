...
var Icon = (_temp2 = _class = function (_PureComponent) {
  ...
  function Icon() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Icon.__proto__ || (0, _getPrototypeOf2.default)(Icon)).call.apply(_ref, [this].concat(args))), _this), _this.config = {}, _this.centralizedUpdates = function (_ref2) {
      var name = _ref2.name,
          data = _ref2.data;
      ...
      return new _core.Icon((0, _extends3.default)({}, _this.config));
