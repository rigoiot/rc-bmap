...
var HeatMap = (_temp2 = _class = function (_PureComponent) {
  (0, _inherits3.default)(HeatMap, _PureComponent);
  ...
  function HeatMap() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = HeatMap.__proto__ || (0, _getPrototypeOf2.default)(HeatMap)).call.apply(_ref, [this].concat(args))), _this), _this.config = {}, _this.centralizedUpdates = function (_ref2) {
      var name = _ref2.name,
          data = _ref2.data;
  ...
  (0, _createClass3.default)(HeatMap, [{
    ...
    value: function componentDidMount() {
      ...
      _core.Util.syncScript('https://api.map.baidu.com/library/Heatmap/2.0/src/Heatmap_min.js').then(function () {
        _this2.tool = new _core.HeatMap((0, _extends3.default)({}, _this2.config), map);
