...
var AutoComplete = (_temp2 = _class = function (_PureComponent) {
  ...
  function AutoComplete() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = AutoComplete.__proto__ || (0, _getPrototypeOf2.default)(AutoComplete)).call.apply(_ref, [this].concat(args))), _this), _this.instance = null, _this.config = {}, _this.centralizedUpdates = function (_ref2) {
      var name = _ref2.name,
          data = _ref2.data;
  ...
  (0, _createClass3.default)(AutoComplete, [{
    ...
    value: function componentDidMount() {
      ...
      this.control = new _core.AutoComplete(this.config);
