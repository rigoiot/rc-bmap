...
var Label = function (_BaseOverlay) {
  ...
  function Label() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Label.__proto__ || (0, _getPrototypeOf2.default)(Label)).call.apply(_ref, [this].concat(args))), _this), _this.outOfRangeOpts = [], _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }
  ...
  (0, _createClass3.default)(Label, [{
    ...
    value: function init() {
      ...
      if (config.offset) {
        config.offset = _utils2.default.convert2BSize(config.offset);
      }
      var options = getLabelOptions(config);
      this.instance = _map2.default.BLabel(config.content, options);
